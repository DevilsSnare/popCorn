...
function set_carousel(mov1, mov2, mov3){
    ...
    //document.getElementById('movie4').innerHTML='<img class="bd-placeholder-img" width="100%" height="100%" src="'+mov4[1]+'"><div class="container"><div class="carousel-caption"><h1>'+mov4[0]+'</h1><p>'+mov4[2]+'</p><p><a class="btn btn-lg btn-danger" href="#target1" onclick="load_details('+mov4[3]+')">Look up</a></p></div></div>';
    //document.getElementById('movie5').innerHTML='<img class="bd-placeholder-img" width="100%" height="100%" src="'+mov5[1]+'"><div class="container"><div class="carousel-caption"><h1>'+mov5[0]+'</h1><p>'+mov5[2]+'</p><p><a class="btn btn-lg btn-danger" href="#target1" onclick="load_details('+mov5[3]+')">Look up</a></p></div></div>';
}
